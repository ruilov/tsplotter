...
(function ($) {
    ...
    function popupClick(e) {
        ...
        // Execute the command
        if(data.command=="forecolor") { // RLV
            var color_callback = editor.options.color_cb;
            if(color_callback) color_callback(data.value);
        }
    ...
    function refresh(editor) {
        ...
        doc.write(
            ...
            '<body id="inner_body" style="' + options.bodyStyle + '"></body></html>'
        );
        doc.close();
        ...
        $(function () {
            ...
            $frame.width("100%").height("100%"); // RLV

            // Resize the textarea. IE6 textareas have a 1px top
            // & bottom margin that cannot be removed using css.
            // editor.$area.width(wid).height(ie6 ? hgt - 2 : hgt); // RLV
