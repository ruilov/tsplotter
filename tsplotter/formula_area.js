class FormulaArea {
  ...
  constructor() {
    ...
    $("#formula_area").cleditor({
      ...
      color_cb: function(color) {tt.color_cb(color);},
    });
    this.add_shortcuts();
  };
  ...
  add_shortcuts() {
    ...
    for(var sc in key_shortcuts) {
      ...
      shortcut.add(sc,key_shortcuts[sc],{'target':this.formula_editor.doc});
    };
  };
  ...
  ctrl_alt_c_cb() {
    this.generic_formula_area_cb(false,function(x) {x.color = false;});
  };
